...
<?php
$address_event = get_field('location', $event_id);
if(!empty($address_event)){
    $locations[] = [
        'id_event' => 'event',
        'lat' => $address_event['lat'],
        'lng' => $address_event['lng']
    ];
}
        ...
        jQuery(document).ready(function ($) {
            async function initMap() {
                ...
                function createMarker(location) {
                    ...
                    priceTag.className = "price-tag "+location.id_event+"";
