...
?>
<div id="horizontal-slider-<?php echo esc_attr($widget_id); ?>" class="horizontal-slider-wrapper" data-autoplay="<?php echo intval($timer); ?>" data-loop="<?php echo intval($loop); ?>" data-navigation="<?php echo intval($navigation); ?>" data-pagination="<?php echo intval($pagination); ?>" data-fullscreen="<?php echo intval($fullscreen); ?>">
<?php
		$counter = 0;
...
?>
		<div class="horizontal-slider-cell" style="height:<?php echo intval($settings['height']['size']).$settings['height']['unit']; ?>;">
			<div class="horizontal-slider-content" style="width:<?php echo intval($content_width); ?>%;">
				<div class="horizontal-slider-content-wrap">
					<div class="horizontal-slider-content-cell">
						<?php
							...
							{
						?>
							 <div class="horizontal-slide-content-subtitle"><?php echo esc_html($slide['slide_subtitle']); ?></div>
						 <?php
							 }
			...
			<?php
				switch($count_slide_img)
				{
					case 1:
			?>
			<div class="horizontal-slider-bg" style="width:<?php echo intval($gallery_width); ?>%;">
