		...
		<div class="timeline-entry">
			<div class="timeline-title">
				<?php 
					...
					{
				?>
					<div class="timeline-image"><img src="<?php echo esc_url($image_url[0]); ?>" alt="<?php echo esc_attr($image_alt); ?>"/></div>
				<?php
					}
				?>
				<h3><?php echo esc_html($slide['slide_title']); ?></h3>
			</div>
			<div class="timeline-body"><p><?php echo htmlspecialchars_decode($slide['slide_description']); ?></p></div>
		</div>
<?php
			$count++;
		}
