...
<div <?php post_class(array('blog-posts-'.$settings['layout'], 'blog-posts-grid', 'blog-tilt', $smoove_class, $animation_class)); ?> <?php if(!empty($blog_featured_img_url)) { ?>style="background-image:url(<?php echo esc_url($blog_featured_img_url); ?>);"<?php } ?> data-delay="<?php echo intval($queue*100); ?>">
