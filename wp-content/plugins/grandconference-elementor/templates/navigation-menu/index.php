...
?>
<div class="themegoods-navigation-wrapper menu_<?php echo esc_attr($settings['nav_menu_hover_style']); ?>  sub_menu_<?php echo esc_attr($settings['sub_menu_hover_effect']); ?>"><?php 	
