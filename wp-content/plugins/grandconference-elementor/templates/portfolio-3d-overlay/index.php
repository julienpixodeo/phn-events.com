...
?>
		<div class="portfolio-grid-wrapper-overlay grid_tilt <?php echo esc_attr($column_class); ?> <?php echo esc_attr($last_class); ?>  portfolio-<?php echo esc_attr($count); ?> tile scale-anm <?php echo esc_attr($portfolio_item_cat); ?> all <?php echo esc_attr($filterable_class); ?> <?php echo esc_attr($smoove_class); ?> <?php echo esc_attr($animation_class); ?> <?php echo esc_attr($settings['entrance_animation']); ?>" data-delay="<?php echo intval($queue*150); ?>" data-minwidth="<?php echo esc_attr($smoove_min_width); ?>" <?php echo $smoove_animation_attr; ?>>
			...
			<div class="figcaption">
				<div class="portfolio-grid-content">
					<div class="portfolio-grid-content-inner">
						<div class="portfolio-grid-content-inner-wrap">
							<h3 class="portfolio_grid_title"><?php echo esc_html($portfolio_title); ?></h3>
							<div class="portfolio-grid-subtitle"><?php echo esc_html($portfolio_subtitle); ?></div>
						</div>
					</div>
				</div>
			</div>
