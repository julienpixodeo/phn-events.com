 ...
 * @since 0.1.0
 */
class GrandConference_Menu_Item_Custom_Fields {
	...
	public static function init() {
		...
		self::$fields = array(
			'megamenu' => __( 'Elementor Mega Menu (optional)', 'grandconference-elementor' ),
		);
	}
	...
	public static function _fields( $id, $item, $depth, $args ) {
		...
		{
			$megamenus_select[''] = __( 'No mega menu found. Please create one first', 'grandconference-elementor' );
		}
...
GrandConference_Menu_Item_Custom_Fields::init();