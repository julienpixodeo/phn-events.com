 ...
 * @since 1.0.0
 */
class GrandConference_Slider_Flip extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-slider-flip';
	}
	...
	public function get_title() {
		return __( 'Flip Slider', 'grandconference-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'mousewheel', 'grandconference-elementor' ];
	}
	...
	protected function register_controls() {
		...
		**/
		...
		$this->add_responsive_control(
		    'slide_width',
		    [
		        'label' => __( 'Slide Width', 'grandconference-elementor' ),
		...
		$this->add_responsive_control(
			'slide_height',
			[
				'label' => __( 'Slide Height', 'grandconference-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 700,
					'unit' => 'px',
				...
				'size_units' => [ 'px', 'vh' ],
				'selectors' => [
					'{{WRAPPER}} .flip-slide-container' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/slider-flip/index.php');
	}
