 ...
 * @since 1.0.0
 */
class GrandConference_Classic_Session_Sidebar extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-classic-session-sidebar';
	}
	...
	public function get_title() {
		return __( 'Classic Session Sidebar', 'grandconference-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
				'sidebar',
				[
					'label' => __( 'Sidebar', 'grandconference-elementor' ),
					'type' => Controls_Manager::SELECT2,
					'options' => grandconference_get_theme_sidebar(),
					'multiple' => false,
				]
			);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li.scheduleday_title h4',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li.scheduleday_title h4, {{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li.scheduleday_title .scheduleday_title_icon span' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li .session_content h6',
				]
			);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li .expandable, {{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li .session_content_wrapper' => 'background: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#e1e1e1',
				'selectors' => [
					'{{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li, {{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li .session_location' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#000000',
				'selectors' => [
					'{{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li .session_content h6' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li',
				]
			);
		...
		$this->add_control(
				...
				[
					...
					'default' => '#222222',
					'selectors' => [
						'{{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li' => 'color: {{VALUE}}',
					],
				]
			);
		...
		$this->add_control(
				...
				[
					...
					'default' => '#FF2D55',
					'selectors' => [
						'{{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li a' => 'color: {{VALUE}}',
					],
				]
			);
		...
		$this->add_control(
				...
				[
					...
					'default' => '#000000',
					'selectors' => [
						'{{WRAPPER}} .session-sidebar-wrapper .scheduleday_wrapper li a:hover' => 'color: {{VALUE}}',
					],
				]
			);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .session-sidebar-wrapper .session_filters li a, {{WRAPPER}} .session-sidebar-wrapper a.session_expand_all',
			]
		);
		
		$this->add_control(
			'filterable_border_color',
			[
				'label' => __( 'Filterable Border Color', 'grandconference-elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#e1e1e1',
				'selectors' => [
					'{{WRAPPER}} .session-sidebar-wrapper .sidebar_wrapper .session_expand_all' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#000000',
				'selectors' => [
					'{{WRAPPER}} .session-sidebar-wrapper .session_filters li a, {{WRAPPER}} .session-sidebar-wrapper a.session_expand_all' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
				...
				[
					...
					'default' => '#ffffff',
					'selectors' => [
						'{{WRAPPER}} .session-sidebar-wrapper .session_filters li a:hover' => 'color: {{VALUE}}',
					],
				]
			);
		...
		$this->add_control(
				...
				[
					...
					'default' => '#FF2D55',
					'selectors' => [
						'{{WRAPPER}} .session-sidebar-wrapper .session_filters li a:hover' => 'background-color: {{VALUE}}',
					],
				]
			);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .session-sidebar-wrapper .session_filters li a.active' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
					...
					'default' => '#FF2D55',
					'selectors' => [
						'{{WRAPPER}} .session-sidebar-wrapper .session_filters li a.active' => 'background-color: {{VALUE}}',
					],
				]
		);
		...
		$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors' => [
						'{{WRAPPER}} .session-sidebar-wrapper .session_filters li a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->add_responsive_control(
				...
				[
					...
					'size_units' => [ 'px' ],
					'selectors' => [
						'{{WRAPPER}} .session-sidebar-wrapper .session_filters li a, {{WRAPPER}} .session-sidebar-wrapper .sidebar_wrapper .session_expand_all' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/classic-session-sidebar/index.php');
	}
