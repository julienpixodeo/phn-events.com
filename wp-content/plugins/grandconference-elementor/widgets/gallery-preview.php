 ...
 * @since 1.0.0
 */
class GrandConference_Gallery_Preview extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-gallery-preview';
	}
	...
	public function get_title() {
		return __( 'Gallery Preview', 'grandconference-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'slick', 'tweenmax', 'grandconference-elementor' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'vh' ],
				'selectors' => [
					'{{WRAPPER}} .fullscreen-gallery-preview-wrapper' => 'height: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Pagination & Navigation', 'grandconference-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/gallery-preview/index.php');
	}
