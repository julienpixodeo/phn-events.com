 ...
 * @since 1.0.0
 */
class GrandConference_Gallery_Masonry extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-gallery-masonry';
	}
	...
	public function get_title() {
		return __( 'Masonry Gallery', 'grandconference-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'masonry', 'grandconference-elementor' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .grandconference-gallery-grid-content-wrapper div.gallery-grid-item' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/gallery-masonry/index.php');
	}
