 ...
 * @since 1.0.0
 */
class GrandConference_Slider_Parallax extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-slider-parallax';
	}
	...
	public function get_title() {
		return __( 'Parallax Slider', 'grandconference-elementor' );
	}
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/slider-parallax/index.php');
	}
