 ...
 * @since 1.0.0
 */
class GrandConference_Gallery_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-gallery-grid';
	}
	...
	public function get_title() {
		return __( 'Grid Gallery', 'grandconference-elementor' );
	}
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/gallery-grid/index.php');
	}
