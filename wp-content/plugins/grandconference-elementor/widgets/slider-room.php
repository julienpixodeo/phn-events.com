 ...
 * @since 1.0.0
 */
class GrandConference_Slider_Room extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-slider-room';
	}
	...
	public function get_title() {
		return __( 'Fullscreen 3D Room Slider', 'grandconference-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'imagesloaded', 'anime-old', 'grandconference-elementor' ];
	}
	...
	protected function register_controls() {
		...
		**/
		...
		$repeater->add_control(
			'slide_image', [
				'label' => __( 'Image (max. 8)', 'grandconference-elementor' ),
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/slider-room/index.php');
	}
