 ...
 * @since 1.0.0
 */
class GrandConference_Slider_Split_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-slider-split-carousel';
	}
	...
	public function get_title() {
		return __( 'Split Carousel Slider', 'grandconference-elementor' );
	}
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/slider-split-carousel/index.php');
	}
