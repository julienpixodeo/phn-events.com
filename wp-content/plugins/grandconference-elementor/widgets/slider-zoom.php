 ...
 * @since 1.0.0
 */
class GrandConference_Slider_Zoom extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-slider-zoom';
	}
	...
	public function get_title() {
		return __( 'Zoom Slider', 'grandconference-elementor' );
	}
	...
	protected function register_controls() {
		...
		**/
		...
		$this->add_responsive_control(
		    'title_margintop',
		    [
		        'label' => __( 'Title Margin Top (in px)', 'grandconference-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 45,
		        ],
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Background', 'grandconference-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
		    'overlay_background',
		    [
		        'label' => __( 'Overlay Background', 'grandconference-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0000000',
		        'selectors' => [
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/slider-zoom/index.php');
	}
