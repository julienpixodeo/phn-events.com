 ...
 * @since 1.0.0
 */
class GrandConference_Slider_Clip_Path extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-slider-clip-path';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Clip Path Slider', 'grandconference-elementor' );
	}
	...
	protected function register_controls() {
		...
		**/
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Navigation Arrow Color', 'grandconference-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#999999',
		        'selectors' => [
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/slider-clip-path/index.php');
	}
