 ...
 * @since 1.0.0
 */
class GrandConference_Flip_Box extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-flip-box';
	}
	...
	public function get_title() {
		return __( 'Flip Box', 'grandconference-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
		    'default_image',
		    [
		        'label' => __( 'Default Background Image', 'grandconference-elementor' ),
		...
		$this->add_control(
		    'default_icon',
		    [
		        'label' => __( 'Default Icon', 'grandconference-elementor' ),
		        'type' => Controls_Manager::MEDIA,
		    ]
		);
		...
		$this->add_responsive_control(
		    'icon_max_width',
		    [
		        'label' => __( 'Icon Max Width (in px)', 'grandconference-elementor' ),
		...
		$this->add_control(
		    'default_title',
		    [
		        'label' => __( 'Default Title', 'grandconference-elementor' ),
		...
		/*$this->add_control(
		    'default_description',
		    [
		        'label' => __( 'Default Description', 'grandconference-elementor' ),
		...
		$this->add_control(
		    'flip_image',
		    [
		        'label' => __( 'Flip Background Image', 'grandconference-elementor' ),
		        'type' => Controls_Manager::MEDIA,
		    ]
		);
		...
		$this->add_control(
		    'flip_title',
		    [
		        'label' => __( 'Flip Title', 'grandconference-elementor' ),
		        'type' => Controls_Manager::TEXT,
		    ]
		);
		...
		$this->add_control(
		    'flip_button_title',
		    [
		        'label' => __( 'Flip Button Title', 'grandconference-elementor' ),
		        'type' => Controls_Manager::TEXT,
		    ]
		);
		...
		$this->add_control(
		    'flip_button_link',
		    [
		        'label' => __( 'Flip Button Link', 'grandconference-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Default Content', 'grandconference-elementor' ),
		...
		$this->add_control(
		    'default_title_color',
		    [
		        'label' => __( 'Default Title Color', 'grandconference-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Default Title Typography', 'grandconference-elementor' ),
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Default Description Color', 'grandconference-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Default Description Typography', 'grandconference-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Flip Content', 'grandconference-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
		    'flip_title_color',
		    [
		        'label' => __( 'Flip Title Color', 'grandconference-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Flip Title Typography', 'grandconference-elementor' ),
		...
		$this->add_control(
		    'button_bg_color',
		    [
		        'label' => __( 'Flip Button Background Color', 'grandconference-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#3d64ff',
		        'selectors' => [
		...
		$this->add_control(
		    'button_font_color',
		    [
		        'label' => __( 'Flip Button Font Color', 'grandconference-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Flip Button Hover Background Color', 'grandconference-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Flip Button Hover Font Color', 'grandconference-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#222222',
		        'selectors' => [
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/flip-box/index.php');
	}
