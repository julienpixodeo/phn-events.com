 ...
 * @since 1.0.0
 */
class GrandConference_Slider_Transitions extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-slider-transitions';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Transitions Slider', 'grandconference-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'swiper', 'grandconference-elementor' ];
	}
	...
	protected function register_controls() {
		...
		**/
		...
		$repeater->add_control(
			'slide_image_left', [
				'label' => __( 'Image Left', 'grandconference-elementor' ),
		...
		$repeater->add_control(
			'slide_image_right', [
				'label' => __( 'Image Right', 'grandconference-elementor' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'label_block' => true,
			]
		);
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/slider-transitions/index.php');
	}
