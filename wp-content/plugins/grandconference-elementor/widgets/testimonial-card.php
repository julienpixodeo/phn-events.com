 ...
 * @since 1.0.0
 */
class GrandConference_Testimonial_Card extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-testimonial-card';
	}
	...
	public function get_title() {
		return __( 'Testimonial Card', 'grandconference-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
		    'card_border_color',
		    [
		        'label' => __( 'Card Border Color', 'grandconference-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#e7e7e7',
		        'selectors' => [
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/testimonial-card/index.php');
	}
