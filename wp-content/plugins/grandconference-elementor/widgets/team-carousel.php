 ...
 * @since 1.0.0
 */
class GrandConference_Team_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'grandconference-team-carousel';
	}
	...
	public function get_title() {
		return __( 'Team Carousel', 'grandconference-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .team-carousel-wrapper.style2 .item' => 'height: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'grid_style' => 'style2',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .team-carousel-image .team-carousel-image-overflow img' => 'border-radius: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .team-carousel-wrapper.style2 .item' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .team-carousel-wrapper .team-carousel-title',
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#111111',
		        'selectors' => [
		            '{{WRAPPER}} .team-carousel-wrapper .team-carousel-title' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .team-carousel-wrapper .team-carousel-subtitle',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#111111',
				'selectors' => [
					'{{WRAPPER}} .team-carousel-wrapper .team-carousel-subtitle' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .team-carousel-wrapper .team-carousel-desc',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#86868B',
				'selectors' => [
					'{{WRAPPER}} .team-carousel-wrapper .team-carousel-desc' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#cccccc',
		        'selectors' => [
		            '{{WRAPPER}} .team-carousel-wrapper .owl-carousel .owl-dots .owl-dot span' => 'background: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#000000',
		        'selectors' => [
		            '{{WRAPPER}} .team-carousel-wrapper .owl-carousel .owl-dots .owl-dot.active span' => 'background: {{VALUE}}',
		        ],
		    ]
		);
	...
	protected function render() {
		include(GRANDCONFERENCE_ELEMENTOR_PATH.'templates/team-carousel/index.php');
	}
