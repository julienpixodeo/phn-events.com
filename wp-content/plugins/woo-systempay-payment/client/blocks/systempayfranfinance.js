...
const PAYMENT_METHOD_NAME = 'systempayfranfinance';
...
const Content = () => {
    ...
    jQuery('.wc-block-components-checkout-place-order-button').on('click', systempay_get_selected_option(['systempayfranfinance_option']));
