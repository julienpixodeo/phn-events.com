...
class WC_Gateway_SystempayRegroupedOther extends WC_Gateway_SystempayStd
{
    ...
    public function init_form_fields()
    {
        ...
        $smartform_mode = SystempayTools::is_embedded_payment();
        ...
        if ($smartform_mode) {
            $columns['integrated_mode'] = array(
                'title' => __('Embedded mode', 'woo-systempay-payment'),
                'width' => '92px',
            );
        }
    ...
    public function systempay_admin_head_script()
    {
        ...
        //<!--
                    ...
                    switch (attr) {
                        ...
                        case 'integrated_mode':
                            if (smartformActivated) {
                                ...
                                optionLine += '<input type="checkbox" name="' + inputName + '" id="' + inputName + '" ' + checked + ' onclick="javascript:systempayActivateFields(\'' + inputName + '\', \'' + orderedRecord.validation_mode + '\', \'' + orderedRecord.capture_delay + '\');" >';
                                optionLine += '</td>';
                            }
            ...
            function systempayActivateFields(checkboxId, validationMode, captureDelay) {
